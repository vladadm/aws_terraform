...
timer = setInterval(function () {
  ...
  document.getElementById("numblock days").innerHTML = pad(res.getUTCDate() - 1);
    document.getElementById("numblock hours").innerHTML = pad(res.getUTCHours());
    document.getElementById("numblock mins").innerHTML = pad(res.getUTCMinutes());
    document.getElementById("numblock secs").innerHTML = pad(res.getUTCSeconds());
    // }
}, 1000)
